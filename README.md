# [Ansible role sysstat](#ansible-role-sysstat)

Install, start and enable sysstat on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-sysstat/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-sysstat/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-sysstat.svg)](https://github.com/buluma/ansible-role-sysstat/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-sysstat.svg)](https://github.com/buluma/ansible-role-sysstat/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-sysstat.svg)](https://github.com/buluma/ansible-role-sysstat/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/sysstat)](https://galaxy.ansible.com/ui/standalone/roles/buluma/sysstat/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-sysstat/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-sysstat/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-sysstat
